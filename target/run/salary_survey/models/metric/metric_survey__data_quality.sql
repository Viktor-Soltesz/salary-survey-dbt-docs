    ...
    create or replace table `software-developer-salaries`.`surveys`.`metric_survey__data_quality`
      
    
    

    OPTIONS(
      description="""Summary metrics of data quality issues encountered in the survey pipeline. Each column corresponds to a specific issue type detected at various stages.\n"""
    )
    as (
